...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin-css/customer-admin.css">
...
<style>
  ...
  .dropdown:hover .dropdown-content {
        ...
        <div class="navbar-area">
            <div class="container">
                <nav class="site-navbar">
                    <!-- site logo -->
                    <a href="dashboard.jsp" class="site-logo">Admin</a>
	...
	<sql:query var="allCUstomer" dataSource="${dbConnection}">
 	...
 	<div class="user-table">
  		<table>
   			<tr>
            	...
            	<th class="customer"> Photo</th>
        	</tr>
       		<c:forEach var="register" items="${allCUstomer.rows}">
				<tr>
					<td>${register.username}</td>
					<td>${register.email}</td>
					<td><img src="http://localhost:8080/images/${register.image}" alt="xyz"></td>
				</tr>
		 	</c:forEach>
  		</table>
 	</div>
