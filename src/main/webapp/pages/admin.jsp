...
<style>
            ...
            <div class="container">
                <nav class="site-navbar">
                    ...
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/pages/admminProduct.jsp">Product</a></li>
 ...
 <!-- Step 1: Create a database connection -->
	...
	<sql:query var="allAdmin" dataSource="${dbConnection}">
		SELECT * FROM admin
	</sql:query>
...
<!-- Step 3: Display the data on the home page using JSTL and CSS -->
 	...
 	<div class="user-table">
  		<table>
   			<tr>
            <th class="admin">Admin Name</th>
            <th class="admin">Email</th>
        	</tr>
       		<c:forEach var="admin" items="${allAdmin.rows}">
				<tr>
